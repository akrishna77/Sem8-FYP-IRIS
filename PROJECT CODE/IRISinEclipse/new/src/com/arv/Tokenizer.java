...
/**
 *  This class tokenizes, removes stop words and then uses
...
//		stemWords();
	 ...
	 */
	private void removeStopWords(String[] stopWords1) {

		for (String string : stopWords1) {
			this.stopWords.add(string.trim());
		}
